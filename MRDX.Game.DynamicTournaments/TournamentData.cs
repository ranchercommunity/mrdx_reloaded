...
public class TournamentData
{
    ...
    "Atronaph", "Argus", "Aideen", "Alias",
    "Bajor", "Beekler", "Bobbles", "Buu",
    "Calaphyx", "Cawcaws", "Cix", "Cerrusio",
    "David", "Dingus", "Dakadaka", "Dill", "Doodle",
    "Eater", "Eo", "Endofall",
    "Fargus", "Fillero", "Ferrus", 
    "Gronkula", "Gimmles", "Golox", "Gargamel", "Gutterman",
    "Hardness", "Herman", "Hillox", "Hundredyear",
    "Io", "Iodine", "Iaz", "Illomens", "Incarnate",
    "Jax", "Jack", "Jillian", "Jellyjam", "Julius",
    "Kawkaws", "Ki", "Kallus", "Keith", "Kevin", "Kitten",
    "Larrius", "Lengeru", "Ludwiz", "Longboy", "Llij",
    "Moparscape", "Mardok", "Mueller", "Mastodon", "Murph", "McNasty",
    "Nilus", "Nevarine", "Nix",
    "Ox", "Otherwilds", "Outerspace", "Oiler", "Officer",
    "Parrix", "Pickle", "Piledriver", "Puffpuff",
    "Quizler", "Qix", "Quark",
    "Roachest", "Rizz", "Rue",
    "Savi", "Silverhand", "Sammy", "Soothsayer", "Swissmiss", "Sully",
    "Tav", "Traveller", "Taximon", "Truegold", "Tuskies",
    "Underway", "Uco",
    "Valiant", "Violence", "Vorton", "Voodoo",
    "Wabberjack", "Warbler", "Werebaby",
    "Xilla", "Xerces",
    "Yoyo", "Yanger", "Yucca",
    "Zoro"];
